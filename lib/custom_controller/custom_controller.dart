...
class CustomController extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const BoidsAnimation();
  }
}

class BoidsAnimation extends StatefulWidget {
  const BoidsAnimation({Key? key}) : super(key: key);
...
class DashPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final wing = Path()
      ..moveTo(0, 40)
      ..lineTo(45, 40)
      ..relativeArcToPoint(const Offset(0, 40),
    ...
    final tip = Path()
      ...
      ..lineTo(140, 60)
      ..lineTo(90, 60);
    final eye = Path()..addOval(const Rect.fromLTWH(80, 40, 10, 10));
    final eyeWhite = Path()..addOval(const Rect.fromLTWH(82.5, 42.5, 3, 3));
    final top = Path()..addOval(const Rect.fromLTWH(50, 6, 20, 10));
    final legL = Path()
      ..moveTo(50, 100)
      ..lineTo(50, 130)
      ..lineTo(52, 135)
    ...
    final faceWhite = Path()
      ..moveTo(90, 50)
      ..relativeArcToPoint(const Offset(-0, 50),
